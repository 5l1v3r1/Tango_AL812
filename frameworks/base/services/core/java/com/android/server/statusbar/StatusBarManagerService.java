        ...
        if (net != mDisabled) {
            ...
            if (mBar != null) {
                try {
                    ...
                    /* HQ_xuqian4 20151116 modified for HQ01498165 LOG*/
                    Slog.d(TAG, "tdp,Object tried to call disable what="+what+",pkg="+pkg);
                    Slog.d(TAG, "tdp,Object tried to call disable:",new Exception("Called by"));
                    /* HQ_xuqian4 20151116 modified end*/
                    mBar.disable(net);
                } catch (RemoteException ex) {
                }
            }
