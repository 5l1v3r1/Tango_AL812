...
public class SignalClusterView
    ...
    public void setVoLTE(boolean isShowed) {
        if (isShowed == true) {
            ...
            mSignalClusterExt.customizeVoLTEIcon(mVoLTEIcon, R.drawable.stat_sys_volte);
            /// M: customize VoLTE icon. @}
    ...
    private void showVoLTEIcon(boolean isShowed, ImageView voLTEIcon, int resid) {
        if (isShowed == true) {
            // VoLTE is on
            /// M: customize VoLTE icon. @{
            mSignalClusterExt.customizeVoLTEIcon(voLTEIcon, resid);
            /// M: customize VoLTE icon. @}
