...
public class SettingsProvider extends ContentProvider {
    ...
    public Bundle call(String method, String request, Bundle args) {
        ...
        if (Settings.CALL_METHOD_PUT_SYSTEM.equals(method)) {
            if (LOCAL_LOGV && android.os.Build.TYPE.equals("eng")) {
    ...
    private Bundle lookupValue(DatabaseHelper dbHelper, String table,
        ...
        synchronized (cache) {
            ...
            if (value != null) {
                ...
                //HQ_xionghaifeng 20151111 add for red line HQ01483759 start
    ...
    private Uri insertForUser(Uri url, ContentValues initialValues, int desiredUserHandle) {
        ...
        if (LOCAL_LOGV && android.os.Build.TYPE.equals("eng")) Log.v(TAG, args.table + " <- " + initialValues
