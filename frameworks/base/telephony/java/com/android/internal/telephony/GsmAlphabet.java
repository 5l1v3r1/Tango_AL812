...
public class GsmAlphabet {
    ...
    public static String getSimMccMnc(int slotId) {
	 	   Log.i("lipeng","[getSimMccMnc]:slotId"+slotId);
		   String codeMNCMCC = mccmncNoSimInserted;
			...
			if ((mccmnc_temp != null) && (mccmnc_temp.length() > 0)) {
			  ...
			  for(int i=0;i<values.length;i++){
	           ...
	           Log.i("lipeng","[getSimMccMnc]:codeMNCMCC1"+codeMNCMCC);
    ...
    static {
     ...
     //add by lipeng for 7-bit tools xml
         /*if(SystemProperties.get("ro.hq.mms.ap.sevenbit").equals("1")) {
                 Resources r = Resources.getSystem();
                 //final String[] array_before = r.getStringArray(com.android.internal.R.array.mms_special_code_framework_before);
                 final String[] array_before = {"δ","φ","γ","λ","Ώ","ω","ώ","π","ψ","ς","σ","θ","ξ","Ά","Α","ά","α","Β","β","Έ","Ε","έ","ε","Ή","Η","ή","η","Ί","ΐ","Ι","Ϊ","ί","ι","ϊ","Κ","κ","Μ","μ","Ν","ν","Ό","Ο","ο","ό","Ρ","ρ","Τ","τ","Χ","χ","Ύ","Υ","Ϋ","υ","ϋ","ύ","ΰ","ζ","Ζ","À","Á","Â","Ã","È","Ê","Ë","Ì","Í","Î","Ï","Ò","Ó","Ô","Õ","Ù","Ú","Û","Ý","á","â","ã","ç","ê","ë","í","î","ï","ó","ô","õ","ú","û","ý","ÿ","ą","ś","ć","ż","ź","ę","ł","ń","ő","ű","Ő","Ű"};
                 //final int[] array_int = r.getIntArray(com.android.internal.R.array.mms_special_code_framework_after);
                 final int[] array_int = {0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x41,0x41,0x41,0x41,0x42,0x42,0x45,0x45,0x45,0x45,0x48,0x48,0x48,0x48,0x49,0x49,0x49,0x49,0x49,0x49,0x49,0x4b,0x4b,0x4d,0x4d,0x4e,0x4e,0x4f,0x4f,0x4f,0x4f,0x50,0x50,0x54,0x54,0x58,0x58,0x59,0x59,0x59,0x59,0x59,0x59,0x59,0x5a,0x5a,0x41,0x41,0x41,0x41,0x45,0x45,0x45,0x49,0x49,0x49,0x49,0x4f,0x4f,0x4f,0x4f,0x55,0x55,0x55,0x59,0x61,0x61,0x61,0xc7,0x65,0x65,0x69,0x69,0x69,0x6f,0x6f,0x6f,0x75,0x75,0x79,0x79,0x61,0x73,0x63,0x7a,0x7a,0x65,0x6c,0x6e,0x6f,0x75,0x4f,0x55};
                 ...
                 String mccmnc = getSimMccMnc(0);//slotId
                 ...
                 String config = String.valueOf(bean.sevenBitConfig);
                 if(config==null ||"".equals(config)){
                         config = "-1";
                 }
                 Log.d("7bit","config :"+config);
                 if(!mccmnc.equals("999999") && array_int!=null && array_int.length>0 &&(array_int.length==array_before.length)){
                         for(int i =0;i< array_int.length;i++){
                                 Log.d("7bit",i+" framework,before: "+array_before[i]);
                                 int beforeCode = array_before[i].charAt(0);
                                 Log.d("7bit",i+" framework,before: beforeCode"+beforeCode+"   after: "+array_int[i]);
                                 defaultCharToGsm.put(beforeCode, array_int[i]);
                                 Log.d("7bit","framework,after defaultCharToGsm: "+defaultCharToGsm.get(beforeCode));
                         }
                 }
