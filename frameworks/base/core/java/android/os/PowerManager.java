...
public final class PowerManager {
    ...
    /**
     * Go to sleep reason code:
     * Going to sleep due to waiting for brightness timeout
     * @hide
     */
    public static final int GO_TO_SLEEP_REASON_WAIT_BRIGHTNESS_TIMEOUT = 9;
...
/* DTS2014112601808 huangwen 00181596 20141126 end>*/
     ...
     * @hide
     */
    public void startWakeUpReady(long currentTime){
    	 try {
    		 mService.startWakeUpReady(currentTime);
		} catch (Exception e) {
    ...
    public void stopWakeUpReady(long currentTime,boolean enableBright){
    	 try {
    		 mService.stopWakeUpReady(currentTime,enableBright);
		} catch (Exception e) {
			// TODO: handle exception
		}
     }
