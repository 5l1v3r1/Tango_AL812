...
/* DTS2014103001999 litao/185177 20141106 end> */
    ...
    public ResolveInfo resolveActivity(Intent intent, int flags) {
        /*HQ_yangfengqing 20151027 modified for GTS testGoogleLocationEnabled Fail begin*/
        if (intent != null && intent.getAction() != null &&
                intent.getAction().equals("com.google.android.gsf.GOOGLE_APPS_LOCATION_SETTINGS")) {
            return null;
        } else {
            return resolveActivityAsUser(intent, flags, mContext.getUserId());
        }
        /*HQ_yangfengqing 20151027 modified end*/
    }
