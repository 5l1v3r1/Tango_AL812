...
public class NetworkTemplate implements Parcelable {
    ...
    public static void fillTemplateForCdmaLte(NetworkTemplate template, int subId) {
        if ("1".equals(SystemProperties.get("ro.mtk_svlte_support"))) {
            ...
            final String svlteSubscriberId = tm.getSubscriberIdForLteDcPhone(subId);
            if (!(TextUtils.isEmpty(svlteSubscriberId)) && svlteSubscriberId.length() > 0){
                Log.d("NetworkTemplate","bf:" + /*template*/ "***");
                template.addMatchSubscriberIds(svlteSubscriberId);
                Log.d("NetworkTemplate","af:" + /*template*/ "***");
            }
        }
    }
    /*HQ_xionghaifeng 20160831 add for HQ02048995 end*/
    ...
    public static NetworkTemplate buildTemplateMobileAll(String subscriberId) {
        /*HQ_xionghaifeng 20160831 add for HQ02048995 start*/
        TelephonyManager tm = TelephonyManager.getDefault();
        NetworkTemplate networkTemplate = new NetworkTemplate(MATCH_MOBILE_ALL, subscriberId, null);
        fillTemplateForCdmaLte(networkTemplate, tm.getSubIdUsingImsi(subscriberId));
        return NetworkTemplate.normalize(networkTemplate, tm.getMergedSubscriberIds());
        /*HQ_xionghaifeng 20160831 add for HQ02048995 end*/
    }
