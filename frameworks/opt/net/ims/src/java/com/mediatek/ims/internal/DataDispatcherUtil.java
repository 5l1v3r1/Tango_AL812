...
public class DataDispatcherUtil {
    ...
    static final int IMC_MAX_SID_LEN= 8;
    static final int IMC_MAX_NID_LEN = 8;
    static final int IMC_MAX_PZID_LEN = 4;
    static final int IMC_MAX_BASE_ID_LEN = 8;
    static final int IMC_MAX_SECTOR_ID_LEN = 36;
    static final int IMC_MAX_SUBNET_LENGTH_LEN = 4;
    static final int IMC_MAX_CARRIER_ID_LEN = 8;
 ...
 static void writeDedicateBearerForHandover(VaEvent event, DedicateBearerProperties property,boolean to3gpp) {
    ...
    static void writeRatCellInfo(VaEvent event, int ratInfo, Context context) {
        ...
        /*Patch for M related changes done for C2K - not used in */
        event.putString(sid,IMC_MAX_SID_LEN);
        event.putString(nid,IMC_MAX_NID_LEN);
        event.putString(pzid,IMC_MAX_PZID_LEN);
        event.putString(baseId,IMC_MAX_BASE_ID_LEN);
        event.putString(sectorId,IMC_MAX_SECTOR_ID_LEN);
        event.putString(subnetLen,IMC_MAX_SUBNET_LENGTH_LEN);
        event.putString(carrierId,IMC_MAX_CARRIER_ID_LEN);
