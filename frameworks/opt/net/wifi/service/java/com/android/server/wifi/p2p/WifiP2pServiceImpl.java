...
public final class WifiP2pServiceImpl extends IWifiP2pManager.Stub {
	...
	if (SystemProperties.get("ro.hq_wlan_direct_tl").equals("1")) {
		return "HUAWEI TAG-TL00_" + id.substring(0,4);
		...
		//modify by wanghui for 20151029 HQ01423369
		return "HUAWEI TAG-CL00";
	} 
	/* HQ01293098, added by zhuxin for wlan p2p device name, begin */
