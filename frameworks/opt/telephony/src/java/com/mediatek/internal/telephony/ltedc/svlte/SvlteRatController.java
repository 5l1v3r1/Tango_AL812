...
public class SvlteRatController extends Handler {
    ...
    public boolean allowRadioPowerOn(int phoneId) {
        ...
        ///M:add for eng mode set LWG mode
        if (mEngMode == ENGINEER_MODE_CSFB && mCdmaPhone.getPhoneId() == phoneId) {
            logd("allowRadioPowerOn=false on CDMA in LWG mode for engineer mode.");
            return false;
        }
