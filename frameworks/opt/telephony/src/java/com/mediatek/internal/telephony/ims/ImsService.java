        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case EVENT_IMS_REGISTRATION_INFO:
					...
					int subId = SubscriptionManager.getSubIdUsingPhoneId(mActivePhoneId);
					int slotId = SubscriptionManager.getSlotId(subId);
					Rlog.d(LOG_TAG, "IMS: socketId = " + socketId + " mActivePhoneId = " + 
					mActivePhoneId + " subId = " + subId + " slotId = " + slotId);
					
					if (socketId != slotId) {
					Rlog.d(LOG_TAG, "IMS: ignore other slot's registration event");
