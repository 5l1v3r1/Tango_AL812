...
*/
    ...
    protected void onDisconnectDone(int connId, AsyncResult ar) {
        ...
        if (apnContext.isEnabled() && mUserDataEnabled
                ...
                && (TextUtils.equals(apnContext.getReason(), Phone.REASON_CONNECTED)
                || TextUtils.equals(apnContext.getReason(), Phone.REASON_DATA_ATTACHED))) {
            if (DBG) {
                log("onDisconnectDone: not set the state as IDLE cause not matching conditions");
            }
        } else {
            apnContext.setState(DctConstants.State.IDLE);
        }
