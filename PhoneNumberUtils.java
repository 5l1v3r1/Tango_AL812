...
//add by huangshuo for HQ01308612 @20151015
    ...
    */
	...
	//add for Iran emergency number 2+110, 4+125, 2+115, 0+112, 0+911 by zhangjinqiang -start
        int slotId=getSlotId();
        String mccmnc = getSimMccMnc(slotId);
        Rlog.d(LOG_TAG, "[getServiceCategoryFromEcc]  mccmnc = "+mccmnc+"dial Num=" + number);
	if("43211".equals(mccmnc)){
	    if("110".equals(number)||"115".equals(number)){
            	Rlog.d(LOG_TAG, "[getServiceCategoryFromEcc]  return 2");
            	return 2;
	    }else if("125".equals(number)){
	        Rlog.d(LOG_TAG, "[getServiceCategoryFromEcc]  return 4");
	        return 4;
	    }
	}
        //add for Iran emergency number by zhangjinqiang -end
