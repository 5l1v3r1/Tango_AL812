...
public class CallForwardEditPreference extends EditPhoneNumberPreference {
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        if (this.mButtonClicked != DialogInterface.BUTTON_NEGATIVE) {
			...
			if(number.equals("112")||number.equals("911")||number.equals("000")
				||number.equals("08")||number.equals("110")||number.equals("118")
				||number.equals("119")||number.equals("999")||number.equals("120")){
				//hejk modified for HQ01929070	
				Toast toast = Toast.makeText(this.getContext(), getContext().getString(R.string.hq_cannt_set_cf),
					Toast.LENGTH_SHORT);
				toast.show();
    ...
    void handleCallForwardResult(CallForwardInfo cf) {
        callForwardInfo = cf;
        if (DBG && android.os.Build.TYPE.equals("eng")) Log.d(LOG_TAG, "handleGetCFResponse done, callForwardInfo=" + callForwardInfo);
            ...
            if (ar.exception != null) {
                ...
                if (cfInfoArray.length == 0) {
                    ...
                    for (int i = 0, length = cfInfoArray.length; i < length; i++) {
                        if (DBG && android.os.Build.TYPE.equals("eng")) Log.d(LOG_TAG, "handleGetCFResponse, cfInfoArray[" + i + "]="
                                + cfInfoArray[i]);
