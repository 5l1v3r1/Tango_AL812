...
//                    Uri ringtoneUri = audioProfileMgr.getRingtoneUri(audioProfileMgr.getActiveProfileKey(), AudioProfileManager.TYPE_RINGTONE, subId);
                    ...
                    /* HQ_zhangpeng5 2015-11-16 modified for sim2 ringtone set null HQ01509634 begin */
                    if(ringtoneUri != null){
                    ...
                    /* HQ_zhangpeng5 2015-11-16 modified for sim2 ringtone set null HQ01509634 end */
                 } else { //add end
		...
		/** add by liruihong for HQ01435293 for play call waiting when in silent mode begin*/
		        int ringerMode = audioManager.getRingerModeInternal();
                        /** modify by qiyanlong for play call waiting when headset connection in silent mode*/
                        boolean isHeadsetConnection = audioManager.isWiredHeadsetOn() || mCallAudioManager.isBluetoothAudioOn();
                        if (ringerMode == AudioManager.RINGER_MODE_SILENT && mCallWaitingPlayer == null && isHeadsetConnection){
	                mCallWaitingPlayer =
		...
		/** add by liruihong for HQ01435293 for play call waiting when in silent mode begin*/
            ...
            //modify by zhangjinqiang for HQ01707843-start
        	/*modify by hejingkui for HQ01852437*/
        	Call inComingGroundCall = mCallsManager.getRingingCall();
        	android.util.Log.d("hejk","inComingGroundCall == null" + (inComingGroundCall == null) + "foregroundCall.getState()" + foregroundCall.getState());
        	if((foregroundCall.getState() == CallState.PRE_DIAL_WAIT)||
            		((inComingGroundCall == null) && (foregroundCall.getState() == CallState.ACTIVE))) {
            	return;
            }
            //modify by zhangjinqiang for HQ01707843-end
            /// @}
