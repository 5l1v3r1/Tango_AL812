...
//            mStatusListener.onMessageSent();
    ...
    */
    ...
    private String getSevenBitMessage(String msg) {
        ...
        if((MessageUtils.getSmsEncodingType(mActivity)!=1)
        		&& (MessageUtils.getSmsEncodingType(mActivity)!=0)){
        	return msg;
        }
        
        //if(MessageUtils.seventSlovakia()){
        //	return msg;
        //}
        
        /*if(MessageUtils.seventPortuguese()){//add case for europe Portuguese
        	String[] before = {"Ë","Ï","Ð","Ý","Þ","ë","ï","ð","ý","þ","ÿ"};
        	 String[] after = {"E","I","D","Y","Y","e","i","e","y","y","y"};
        	 String newMsgTemp = new String(msg);
        	 if(before.length==after.length){
        		 for (int j = 0; j < before.length; j++) {
     				newMsgTemp = newMsgTemp.replace(before[j], after[j]);
     			}
        	 }
        	return newMsgTemp;
        }*/
        //to do by lipeng for cts not pass
        //String[] specialUnicode = mActivity.getResources().getStringArray(com.android.internal.R.array.mms_special_code_before);
String[] specialUnicode = {"δ","φ","γ","λ","Ώ","ω","ώ","π","ψ","ς","σ","θ","ξ","Ά","Α","ά","α","Β","β","Έ","Ε","έ","ε","Ή","Η","ή","η","Ί","ΐ","Ι","Ϊ","ί","ι","ϊ","Κ","κ","Μ","μ","Ν","ν","Ό","Ο","ο","ό","Ρ","ρ","Τ","τ","Χ","χ","Ύ","Υ","Ϋ","υ","ϋ","ύ","ΰ","ζ","Ζ","À","Á","Â","Ã","È","Ê","Ë","Ì","Í","Î","Ï","Ò","Ó","Ô","Õ","Ù","Ú","Û","Ý","á","â","ã","ç","ê","ë","í","î","ï","ó","ô","õ","ú","û","ý","ÿ","ą","ś","ć","ż","ź","ę","ł","ń","ő","ű","Ő","Ű"};
        //String[] specialSevenBit = mActivity.getResources().getStringArray(com.android.internal.R.array.mms_special_code_after);
String[] specialSevenBit ={"Δ","Φ","Γ","Λ","Ω","Ω","Ω","Π","Ψ","Σ","Σ","Θ","Ξ","A","A","A","A","B","B","E","E","E","E","H","H","H","H","I","I","I","I","I","I","I","K","K","M","M","N","N","O","O","O","O","P","P","T","T","X","X","Y","Y","Y","Y","Y","Y","Y","Z","Z","A","A","A","A","E","E","E","I","I","I","I","O","O","O","O","U","U","U","Y","a","a","a","Ç","e","e","i","i","i","o","o","o","u","u","y","y","a","s","c","z","z","e","l","n","o","u","O","U"};
		//String[] others=mActivity.getResources().getStringArray(com.android.internal.R.array.mms_special_code_to_space);
        
		String newMsg = new String(msg);
		if (specialUnicode != null && specialUnicode.length > 0) {
			for (int i = 0; i < specialUnicode.length; i++) {
				newMsg = newMsg.replace(specialUnicode[i], specialSevenBit[i]);
			}
		}
		
		//replace charater to space
		/*if (others != null && others.length > 0) {
			for (int i = 0; i < others.length; i++) {
				newMsg = newMsg.replace(others[i], " ");
			}
		}*/
        return newMsg;
    }//end by lipeng for 7-bit
