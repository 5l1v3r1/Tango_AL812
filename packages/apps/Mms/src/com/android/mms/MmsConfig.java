...
//import com.mediatek.encapsulation.android.provider.EncapsulatedSettings;//add by lipeng
//import com.mediatek.telephony.SimInfoManager;
...
public class MmsConfig {
    ...
    public static int getSmsToMmsTextThreshold() {
        ...
        if(SystemProperties.get("ro.hq.mms.ap.smstomms").equals("1")) {
            return MessageUtils.loadSmsToMmsByMncMcc(MessageUtils.getDefaultMncMcc());
        }//end by lipeng
