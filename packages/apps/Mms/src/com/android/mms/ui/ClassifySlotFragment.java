...
public class ClassifySlotFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
   ...
   /*HQ_sunli HQ01479345 20151105 begin*/
        removeCellbroadcast();
   /*HQ_sunli HQ01479345 20151105 end*/
    ...
    public void removeCellbroadcast() {
        PreferenceCategory CBsettingPref = (PreferenceCategory) findPreference(CB_SETTING_GENERAL);
        getPreferenceScreen().removePreference(CBsettingPref);
    }
   /*HQ_sunli HQ01479345 201501105 end*/
