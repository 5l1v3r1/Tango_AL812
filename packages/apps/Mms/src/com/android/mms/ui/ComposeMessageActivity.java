...
/**/
/*HQ_zhangjing 2015-12-09 modified for CQ  HQ01544198 begin*/
import com.android.mms.ui.ScaleDetector.OnScaleListener;
/*HQ_zhangjing 2015-12-09 modified for CQ  HQ01544198 end*/
...
/*HQ_zhangjing 2015-12-09 modified for CQ  HQ01544198 begin*/
	...
	private void changeTextSize( float size ){
		SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(
			ComposeMessageActivity.this).edit();
		//editor.putInt(FONT_SIZE_SETTING, which);
		editor.putFloat("message_font_size", size);
		editor.apply();
	}
/*HQ_zhangjing 2015-12-09 modified for CQ  HQ01544198 end*/
    ...
    public void initialize(Bundle savedInstanceState, long originalThreadId) {
       ...
       /*HQ_lipeng  add for al812 to add sms signature begin */
       ...
       if ( !mSignatureStr.equals(subtext)
          ...
          mWorkingMessage.setText(subtext +" "+ mSignatureStr);
       }
		/*HQ_lipeng  add for al812 to add sms signature end */
       }
...
//            mStatusBarManager.showSIMIndicator(mComponentName, Settings.System.SMS_SIM_SETTING);
   ...
   @Override
    ...
    public boolean  dispatchTouchEvent(MotionEvent ev) {
        ...
        /// M: Code analyze 001, Plugin opeartor. @{
/*HQ_zhangjing 2015-12-09 modified for CQ  HQ01544198 begin*/
		if( SystemProperties.get("ro.operator.optr").equals("OP02")){
			if (mMmsTextSizeAdjustPlugin != null) {
                ret = mMmsTextSizeAdjustPlugin.dispatchTouchEvent(ev);
            }
		} else {
			if( mScaleDetector != null){
                ret = mScaleDetector.onTouchEvent(ev);
        	}
		}
/*HQ_zhangjing 2015-12-09 modified for CQ  HQ01544198 end*/
        if (!ret) {
