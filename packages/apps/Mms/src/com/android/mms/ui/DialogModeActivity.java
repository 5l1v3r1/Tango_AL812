...
//      mSimName.setText(simCharSequence);
    ...
    private void simSelection() {
        ...
        MmsLog.d(TAG, "mSelectedSubId = " + mSelectedSubId + ",mSendSubIdForOp09 = " + mSendSubIdForOp09);
		if( mSendSubIdForOp09 > 0 && SystemProperties.get("ro.operator.optr").equals("OP09")){
