...
public class ShortcutCardsAdapter extends BaseAdapter {
    ...
    class SwipeableShortcutCard extends FrameLayout implements SwipeHelperCallback {
        ...
        private void prepareChildView(View view) {
            ...
            /** M: The shorcutCards of conference call shouldn't show the
             *  call_indicator_icon if the account doesn't support return call. @{
             */
            final CallLogListItemViews callLogListItemViews = (CallLogListItemViews) view.getTag();
            if (callLogListItemViews.confCallNumbers != null &&
                    !DialerVolteUtils.isVoLTEConfCallEnable(mContext)) {
                callLogItem.findViewById(R.id.call_indicator_icon).setVisibility(
                            View.INVISIBLE);
            }
            /** @} */
        }
