...
//add by zhangjinqiang for al812 end
	...
	if(InCallApp.gIsHwUi){
        ...
        if (bluetoothSupported) {
            ...
            speakerOn.setSelected(audioButtonChecked);
        ...
        //speakerOn.setEnabled(audioButtonEnabled && mIsEnabled);
        speakerOn.setSelected(audioButtonChecked);

        final LayerDrawable layers = (LayerDrawable) speakerOn.getBackground();
    ...
    private void showAudioModePopup() {
        ...
        //Add check contextWrapper is null by Yangzhanwei_20151120
