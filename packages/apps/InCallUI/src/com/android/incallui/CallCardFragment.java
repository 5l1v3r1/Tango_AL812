...
private ImageView dialpd,speakerOn,simView,ntStatus;
...
//private boolean firstShow=false;
	...
	if(InCallApp.gIsHwUi){
		...
		ntStatus=(ImageView)view.findViewById(R.id.nt_status);//add by qiyanlong 
	...
	public void setPrimaryPhoneNumberAndName(String name,String number){
	 ...
	 @Override
	public void setPrimaryPhoneLocator(String locator){
		/*
    ...
    public void setPrimary(String number, String name, boolean nameIsNumber, String label,
		...
		*/
		...
		Log.d("simNum",""+simNum);
        setSimLable(simNum);
		setNtStatus(simNum);//add by qiyanlong 
    ...
    */
    ...
    /// @}
	//add by qiyanlong 
	void setNtStatus(int num){
		Log.i(this, "set Net Status ");
		Resources resource = getActivity().getResources();
		final Drawable hdView = resource.getDrawable(R.drawable.hd_status);
		try{
			boolean status = ImsManager.getInstance(getActivity(), num).getImsRegInfo();
			Log.i(this, "IMS Status "+ status);
			if(status){
				ntStatus.setVisibility(View.VISIBLE);
				ntStatus.setImageDrawable(hdView);
			}else{
				ntStatus.setVisibility(View.INVISIBLE);
			}
		} catch (ImsException e) {
	             Log.v(this, "IMS status failed to get ");
	    }
			
	}
	void setNtStatusInvisible(){
		Log.i(this, "set Net Status INVISIBLE");
		ntStatus.setVisibility(View.INVISIBLE);
		getSubInfoList();		
	}
	//add end
	...
	/*add by liruihong for HQ01440479 begin*/
	 ...
	 if(num != null){
		...
		//setNtStatus(Integer.parseInt(num));//add by qiyanlong //leiyuanhua 160503 del for HQ01890105
	 }
