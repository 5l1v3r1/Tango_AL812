...
public class IconListPreference extends DialogPreference{
    ...
    private static final String GESTURE_DEF_E = "com.android.browser;com.UCMobile.main.UCMobile";
   ...
   private boolean isActivityExist(String component){
    	...
    	if(getKey().equals(LISTPREF_C_KEY)) 
	{
        ...
        if(names.length == 2)
		{
			...
			if(getKey().equals(LISTPREF_E_KEY))
			{
				if("com.android.browser".equals(names[0]) && "com.android.browser.BrowserActivity".equals(names[1]))
				{
					names[1] = "com.UCMobile.main.UCMobile";
				}
			}
