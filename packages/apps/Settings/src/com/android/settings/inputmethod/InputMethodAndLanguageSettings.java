        ...
        if (preference instanceof PreferenceScreen) {
            ...
            if (pref == mGameControllerCategory.findPreference("vibrate_input_devices")) {
                System.putInt(getContentResolver(), Settings.System.VIBRATE_INPUT_DEVICES,
                        pref.isChecked() ? 1 : 0);
                return true;
            } else if (pref == mDigitalSwitchPref) {//HQ_hushunli 2015-08-24 add for HQ01303115
                boolean isChecked = pref.isChecked();
                SystemProperties.set(ARABIC_NUMERALS, isChecked ? "1" : "0");
                Log.d(TAG, "onPreferenceTreeClick, set value is " + (isChecked ? "1" : "0") + ", persist.sys.hq.arabic.numerals is " + SystemProperties.get(ARABIC_NUMERALS));
                return true;
            }
