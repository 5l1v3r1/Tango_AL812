...
public class WifiP2pSettings extends SettingsPreferenceFragment
    ...
    public Dialog onCreateDialog(int id) {
        if (id == DIALOG_DISCONNECT) {
           ...
           /*HQ_sunli 20150804 HQ01299040 begin*/
           /* mDeviceNameText.setFilters(new InputFilter[] {new InputFilter.LengthFilter(30)});*/
            InputFilter filter = new InputFilter() {
                ...
                public CharSequence filter(CharSequence src, int start, int end, Spanned dest, int dstart, int dend) {
                    ...
                    while (count <= DEVICE_NAME_MAX_LENGTH_BYTES && dindex < dest.length()) {
                    ...
                    if (count > DEVICE_NAME_MAX_LENGTH_BYTES) {
                        return dest.subSequence(0, dindex - 1);
                    }
                    
                    int sindex = 0;
                    while (count <= DEVICE_NAME_MAX_LENGTH_BYTES && sindex < src.length()) {
            ...
            /*HQ_sunli 20150804 HQ01299040 end*/
