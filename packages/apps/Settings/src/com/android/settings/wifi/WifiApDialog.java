...
public class WifiApDialog extends AlertDialog implements View.OnClickListener,
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.show_password) {
         ...
         String projetcStr = SystemProperties.get("ro.sys.project.huawei", "");
	     if(SystemProperties.get("ro.hq.wifi.ap.name.pwd").equals("1")){
                    Random random = new Random();
                    String srandom = Integer.toString(random.nextInt(9000)+1000);
                    if(projetcStr.equals("AL")) {
                           mSsid.setText("HUAWEI_TAG_AL00_" + srandom);
                    } else if(projetcStr.equals("TL")) {
                           mSsid.setText("HUAWEI_TAG_TL00_" + srandom);
                    } else if(projetcStr.equals("CL")) {
                           mSsid.setText("HUAWEI_TAG_CL00_" + srandom);
                    } else {
                           mSsid.setText("HUAWEI_TAG_" + srandom);
                    }	
	     	}else{
		      mSsid.setText(s);
		}
