...
public class TouchDisableModeSettings extends PreferenceActivity {

    public static final String TAG = "TouchDisableModeSettings";
    ...
    public void onCreate(Bundle paramBundle) {
        ...
        addPreferencesFromResource(R.xml.touch_disable_mode_settings);
    ...
    OnPreferenceChangeListener mOnPreferenceChangeListener = new OnPreferenceChangeListener() {
		...
		public boolean onPreferenceChange(Preference preference, Object objValue) {
			...
			Settings.System.putInt(getContentResolver(), Settings.System.TOUCH_DISABLE_MODE, touchDisableModeSwitch.isChecked() ? 1 : 0);
			return false;
		}
    };
