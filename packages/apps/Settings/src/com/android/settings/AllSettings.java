   ...
   // private SwitchBar mSwitchBar;
    ...
    private void updateTilesList(List<DashboardCategory> target) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            String phoneType = SystemProperties.get("ro.phoneType","AL812"); //HQ_zhangpeng5 2015-11-05 modified for CL_UI HQ01436077
            while (n >= 0) {
                ...
                if (id == R.id.operator_settings || id == R.id.manufacturer_settings) {
                    ...
                    // Remove sim Settings if WiFi only.
                      /* HQ_zhangpeng5 2015-11-05 modified for CL_UI HQ01436077 begin */
                      if (phoneType.equals("AL812_CL")){
                         removeTile = true;
                      }
                      /* HQ_zhangpeng5 2015-11-05 modified for CL_UI HQ01436077 end */
                      if (mIsWifiOnly) {
                         removeTile = true;
                      }
                    ...
                    /* HQ_zhangpeng5 2015-11-05 modified for CL_UI HQ01436077 begin */
                      if (phoneType.equals("AL812_CL")){
                         mExt.addCustomizedItem(category, 0);
                      }else{
