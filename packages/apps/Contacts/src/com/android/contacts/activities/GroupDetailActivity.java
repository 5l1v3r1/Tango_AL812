...
public class GroupDetailActivity extends ContactsActivity {
    ...
    private final GroupDetailFragment.Listener mFragmentListener =
        ...
        public void onGroupTitleUpdated(String title) {
            ...
            if(title != null && language.equals("en")) {
                if(title.equals("同事")) {
                    getActionBar().setTitle("Work");
                } else if(title.equals("同学")) {
                    getActionBar().setTitle("Classmates");
                } else if(title.equals("家人")) {
                    getActionBar().setTitle("Family");
                } else if(title.equals("朋友")) {
                    getActionBar().setTitle("Friends");
                } else {
                    getActionBar().setTitle(title);
                }
            } else if (title != null && language.equals("zh") && (country.equals("TW") || country.equals("HK"))) {
                if(title.equals("同事")) {
                    getActionBar().setTitle("同事");
                } else if(title.equals("同学")) {
                    getActionBar().setTitle("同學");
                } else if(title.equals("家人")) {
                    getActionBar().setTitle("家人");
                } else if(title.equals("朋友")) {
                    getActionBar().setTitle("朋友");
                } else {
                    getActionBar().setTitle(title);
                }
            } else {
