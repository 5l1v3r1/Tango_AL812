...
//		Toast.makeText(PeopleActivity.this, "号码助手Service通信成功！", Toast.LENGTH_SHORT).show();  
	...
	protected void onResume() {
		...
		if (digits != null && mDialerPlugIn.getPosition() != 0){
	...
	public void onClick(View view) {
		...
		case R.id.LifeService:
			...
			if(!chubao.getBoolean("chubaoWarn", false)){
				...
				/* HQ_fengsimin 2016-3-29 modified for HQ01829481 */
				AlertDialog chubaodialog = builder1.create();
				chubaodialog.show();
				WindowManager wm = getWindowManager();
				if(chubaodialog!=null && wm!=null){
					Window dialogwindow = chubaodialog.getWindow();
...
//        }
	...
	private final TextWatcher mPhoneSearchQueryTextListener = new TextWatcher() {
		...
		public void afterTextChanged(Editable s) {
			...
			String lo = null;
			try{
				lo = csom.getPhoneAttribute(s.toString());
			}catch(Exception e){
				e.printStackTrace();
				return;
			}
