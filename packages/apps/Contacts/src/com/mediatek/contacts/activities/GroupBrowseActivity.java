...
public class GroupBrowseActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView favoriteNumTv=(TextView)startView.findViewById(R.id.favoritesContactsTv);
		favoriteNumTv.setText(getStartedContactsNum()+" "+getResources().getString(R.string.stared_contacts_counts));
